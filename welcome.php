...
$username = stripslashes($loguser);
$password = stripslashes($logpassword);
$username = mysql_real_escape_string($username);
$password = mysql_real_escape_string($password);

$sql="SELECT * FROM $usr_detl WHERE semail='$username' and spassword='$password'";
...
<button type="button" class="btn btn-lg btn-danger " data-container="body" data-placement="bottom" data-toggle="popover" title="Hey Folk!" data-content="Welcome to my page.Excited!?">Ping Me! 
